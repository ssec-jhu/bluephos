...
def test_pipeline(halides_file_name, acids_file_name, input_folder, output_folder):
    ...
    ligand_table_df = generate_ligand_table(inputs, halides_file_name, acids_file_name, output_folder)
    print("GenerateLigandTable Task completed!")

    smiles_to_mol_df = smiles_to_mols(ligand_table_df)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--halides', required=True, help='CSV file containing halides data')
    parser.add_argument('--acids', required=True, help='CSV file containing boronic acids data')
